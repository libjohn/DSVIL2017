...
3. Follow [Intructions](https://docs.google.com/document/d/17iKQG9JfREEEThz_Qeai5lvv5mYPRsixi0MKbS6aIsM/edit#heading=h.hdqpl186tuyo) 1-8
    ...
    - Substitute the site you picked from step b (above)
...
- [Step-by-Step](https://docs.google.com/document/d/173DBCKrfXWT2yGlFeGQ-zaCh5TefwxctL1CoTTQTS1Y/):  1-5

     - URL: http://v.gd/parsing2222 

- Stop after step 5. Unless you're speedy and then give step 6 (regex) a try

    - More information on [Regular Expressions](https://libjohn.github.io/regex/slides/)
...
link to API hands-on parsing GoogleMaps API

---
## Twitter / TAGS

https://libjohn.github.io/twitter-gather/slides.html#1
...
Not sure this slide needs to be here
