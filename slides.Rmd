...
---
## Demonstratation -- Process Outline

1. Fecth HTML by URL from Web Server
...
2. Parse HTML
    ...
    - Edit column > Add column based on this column
        - `parseHTML()`
        - 'select("css handle")'
            - highlight > right-click > inspect (Google Chrome Web Developer Mode)
            - Choose array element, typically `[0]`
            - convert element:
                - `htmlText()`
                - `htmlAttr()`
...
1. Edit Column > Add column based on this column
    ...
    - `value.parseHtml().select("div#centerbox")[0].htmlText()`
